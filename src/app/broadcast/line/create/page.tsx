  ...
  return (
    <LayoutBroadcast>
      <div className="overflow-x-auto relative w-full h-full">
        {" "}
        <div className="px-5 pt-5 pb-3 flex justify-between items-center border-t-[0.5px] overflow-x-auto">
        ...
        <div
          ...
          <Content className="h-full relative bg-white  w-full  pt-4">
            {_.isEmpty(lineId) ? (
              <EmtyChatRoom text="กรุณาเลือกไลน์ที่จะบรอดแคสต์จากด้านซ้าย" />
            ) : (
              <CreateBroadcast />
            )}
          </Content>
