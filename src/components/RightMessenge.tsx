  ...
  return(
   <>
    ...
    <div className="w-[100%] py-2 pr-2 pl-[25%] my-2 ">
      ...
      <div className="inline-block bg-[#FADFBE] px-4 py-2 rounded-b-2xl rounded-l-2xl relative left-[86px]">
        <span className="inline-block">{_prop?.messenge??'It is a long established' }</span>
