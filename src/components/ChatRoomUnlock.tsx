...
import { Avatar, Button, Card, Divider, Layout, Tabs, Tag } from "antd";
        ...
        <Header
          ...
          <div className="flex items-center justify-between">
            <div className="flex">
              <Button
                type="link"
                className="flex items-center text-black p-0 mr-2"
                onClick={() => {
                  _prop.setUserChatRoomLock({});
                }}>
                <svg
                  width="24"
                  height="25"
              ...
              <div className="flex flex-col  w-[30%] ">
                <span className="font-noto chat-name">
                  {_prop.userChatRoomLock?.name}
                </span>
                <div className="flex  items-center">
                  {_prop.userChatRoomLock.app === "Chatfast.app" ? (
                    <MessengerLogo />
                  ) : _prop.userChatRoomLock.app === "Telegram" ? (
                    <TelegramLogo />
                  ) : _prop.userChatRoomLock.app === "Tiktok" ? (
                    <TiktokLogo />
                  ) : _prop.userChatRoomLock.app === "WhatsApp" ? (
                    <WhatsAppLogo />
                  ) : null}
                  <span className="font-noto text-xs ml-1">
                    {_prop.userChatRoomLock?.app}
                  </span>
                </div>
              </div>
            </div>
      ...
      <Sider
        ...
        <div className="w-full h-full absolute right-0 top-0 overflow-scroll pt-[25px]">
          <div className="flex px-[15px] py-[5px]">
            {" "}
            {_prop.userChatRoomLock?.image ? (
              <Avatar size={73} src={_prop.userChatRoomLock.image} />
            ) : (
